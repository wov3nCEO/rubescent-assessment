...
async function rules(client, argv) {
  if (argv.length === 0 || argv[0].startsWith("-")) {
    const lsFn = (await import("./ls-E7FYH3DW.js")).default;
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-E7FYH3DW.js")).default(client, args);
    case "add":
      return (await import("./add-T6ZTAEU2.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-MSPP3V4O.js")).default(client, args);
    case "rm":
      return (await import("./rm-SFC67P5U.js")).default(client, args);
    case "update":
      return (await import("./update-NE62WKTZ.js")).default(client, args);
    default:
